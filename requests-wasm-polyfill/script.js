...
default_txt = `
# This is an example from https://github.com/emscripten-forge/sample-python-repl with (slightly patched) 
# https://github.com/emscripten-forge/requests-wasm-polyfill plugin attached to allow outbound HTTP requests.
# Build and patch instructions are in https://github.com/wasm-outbound-http-examples/pyjs.
import requests
